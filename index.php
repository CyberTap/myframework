...
<head>
	...
	<style>
		#logo{
			display: block;
			background-image: url(http://lawlez.ch/wp-content/uploads/2015/03/lawlez-logo-gold.png);
			width: 179px;
...
<body>
	...
	<header>
		...
		<div class="container">
			<div id="logo" class=" animated slideInLeft"></div>
			
<b id="logout" style=""><a href="index.php?p=logout">Log Out</a></b>
        <div class="container-navi">

            <ul id="nav">
                <li class=" animated slideInDown"><a href="index.php?cat=content&p=home">Home</a></li>
                <li class=" animated slideInDown"><a href="index.php?cat=content&p=music">Musik</a>
                    
                </li>
                <li class=" animated slideInDown"><a href="index.php?cat=content&p=login">Login</a>
                    
                </li>
                <li class=" animated slideInDown"><a href="index.php?cat=content&p=req">Anfrage</a></li>
                <li class=" animated slideInDown"><a href="index.php?cat=content&p=film">Filme</a></li>
...
echo "<h1>Hello,  ".$_SESSION['login_user']." </h1>";
}
?>
</div>
<hr/>
</section><!--
<hr class="smallhr-top"/>
<section class="parallax">
<div class="parallax-window" style="height: 100%; background: transparent;" data-parallax="scroll" data-image-src="http://lawlez.ch/wp-content/uploads/2015/03/lawlez-minibots-header.jpg">
